...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="w-full py-32 px-6 relative z-10">
      <div style={{ maxWidth: '48rem', marginLeft: 'auto', marginRight: 'auto', textAlign: 'center' }}>
        ...
        >
          ...
          <p style={{ color: '#94a3b8', fontSize: '1.125rem', lineHeight: 1.8, marginBottom: '3rem' }}>
            ...
            {socials.map((s, i) => (
              ...
              >
                ...
                <div style={{ textAlign: 'left' }}>
                  <p style={{ fontSize: '0.75rem', fontWeight: 600, color: '#e2e8f0' }}>{s.name}</p>
                  <p style={{ fontSize: '0.7rem', color: '#64748b' }}>{s.handle}</p>
                </div>
              </motion.a>
            ))}
          </div>
      ...
      <motion.div
        ...
        style={{ textAlign: 'center', marginTop: '6rem', color: '#475569', fontSize: '0.75rem' }}
      >
