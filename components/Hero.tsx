  ...
  return (
    <section className="relative flex min-h-screen w-full flex-col items-center justify-center px-6 text-center">
      ...
      <div className="fx-fade-up" style={{ animationDelay: "0.2s" }}>
        <p className="mb-3 text-lg uppercase tracking-widest text-slate-400">Hey there, I&apos;m</p>
      ...
      <div
        className="fx-fade-up mb-8 h-10 text-2xl font-light text-slate-300 md:text-3xl"
      ...
      <div
        className="fx-fade-up flex flex-wrap items-center justify-center gap-4"
